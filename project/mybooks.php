...
<div id="top" style="box-shadow:0px 1px 10px 1px #888888">
    <table cellpadding=12 id="navbar">
      ...
      <a href="mybooks.php" class="navbarlinks active nohighlightlink">My Books </a>&nbsp; &nbsp; &nbsp;
  ...
  <div class="subheader">
    ...
    <p style="margin: 0%;margin-left: 2%;" align=left>Books Owned
      &nbsp; &nbsp; &nbsp;
      <button class="button2-disabled" style="width: 100px;">Move to cart</button>
      &nbsp; &nbsp; &nbsp;
  ...
  <br>
  <br>
  <div style="margin: 0%;margin-left: 2%;">
    <p style="font-size:130%;margin-bottom: 0%;">You have no saved books &nbsp;:(</p>
    </p>
  </div>
</body>
